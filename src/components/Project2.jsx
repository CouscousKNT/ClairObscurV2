  ...
  return (
    <div className="relative content h-screen flex flex-col bg-black overflow-hidden">
      <div className="w-full">
        ...
        <h1
          ref={title2}
          class="absolute text-white font-fujiwara text-2xl top-18"
        >
          La grande échapée
        </h1>
      </div>
      ...
      <div ref={container} className="mt-[10vh] min-h-[100vh]">
        ...
        >
          ...
          <div className="h-full w-full">
            <p className="text-white text-xs border-white">
              Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam
              nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam
              erat volutpat. Ut wisi enim ad minim veniam
            </p>
      ...
      <div className="absolute bottom-0 sm:top-[85vh] text-white w-4/5 flex justify-center items-center ">
        <a
          className="h-10 border-white border-1 flex justify-center items-center pl-4 pr-4"
          href="#"
        >
          Dévouvrir
        </a>
        <p className="text-white text-xs pl-4 sm:pl-8">
          Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam
          nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat
          volutpat.
        </p>
        <div className="h-[50%] border-white border-r-1 pl-4"></div>
      </div>
    </div>
  );
};
